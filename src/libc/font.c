...
// Шрифт 8x8 для ASCII символов (32-127)
// Каждый символ представлен 8 байтами, каждый байт - строка пикселей
// Бит 7 - самый левый пиксель, бит 0 - самый правый

unsigned char font8x8_basic[128][8] = {
    // ASCII 0-31 (управляющие символы) - пустые
